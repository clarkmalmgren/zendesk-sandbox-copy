...
const map: any = {
    ...
    'sinon': 'vendor/sinon/pkg/sinon.js',
    'chai': 'vendor/chai/chai.js',
    'sinon-chai': 'vendor/sinon-chai/lib/sinon-chai.js'
};

const materialPackages:string[] = [ 'core', 'toolbar', 'icon', 'button', 'sidenav', 'list', 'card', 'input', 'radio', 'checkbox', 'slide-toggle' ];
